 ...
 *
 * Only the artefact stages appear. There is no `geometry` stage here: geometry
 * is produced by operation providers through the existing `actions` seam, which
 * already works and needs no second way in.
 */
